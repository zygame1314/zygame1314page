    ...
    function displayGames(games) {
        ...
        games.forEach(game => {
            ...
            if (game.background_image) {
                ...
                gameImage.src = 'https://cdn.jsdmirror.com/gh/zygame1314/zygame1314page@latest/images/default-game-cover.png';
                gameImage.classList.add('default-cover');
            }
            gameImage.alt = game.name || '未知游戏';
            gameImage.onerror = function () {
                this.src = 'https://cdn.jsdmirror.com/gh/zygame1314/zygame1314page@latest/images/default-game-cover.png';

    ...
    function displayGames(games) {
        ...
        games.forEach(game => {
            ...
            if (game.background_image) {
                ...
                gameImage.src = 'https://jsd.onmicrosoft.cn/gh/zygame1314/zygame1314page@1.3.1/images/default-game-cover.png';
                gameImage.classList.add('default-cover');
            }
            gameImage.alt = game.name || '未知游戏';
            gameImage.onerror = function () {
                this.src = 'https://jsd.onmicrosoft.cn/gh/zygame1314/zygame1314page@1.3.1/images/default-game-cover.png';
